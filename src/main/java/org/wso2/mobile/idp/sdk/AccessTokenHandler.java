...
public class AccessTokenHandler extends Activity {
    ...
    public AccessTokenHandler(Context context,Activity activity){
    ...
    public void obtainAccessToken(String code){
        new NetworkCallTask(activity).execute(code);
    }
    ...
    private class NetworkCallTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Map<String, String> response_params = ServerUtilities.postData(context,ClientCredentials.getInstance().getAccessTokenURL(), request_params);
